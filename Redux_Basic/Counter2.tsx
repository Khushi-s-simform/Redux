...
import { incrementCount2, decrementCount2 } from './actions/countActions';
//@ts-ignore
import Icon from 'react-native-vector-icons/dist/Feather';

const Counter2 = () => {
  const count = useSelector((state: any) => state.value2);
    console.log(count);
      ...
      <View style={{ gap: 20 }}>
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            dispatch(incrementCount2()); // no payload → default +1
          }}
        >
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            dispatch(incrementCount2(5)); // payload → +5
          }}
        >
          {/* UI showing +5 action */}
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
            <Text style={{justifyContent:'center',alignItems:'center'}}>+5</Text>
             <Icon name="plus" size={20} style={styles.icon}  />
          </View>
        </TouchableOpacity>
